<template>
<uni-shadow-root class="dist-dropdown-menu-index"><view class="van-dropdown-menu van-dropdown-menu--top-bottom custom-class">
...
global['__wxRoute'] = 'dist/dropdown-menu/index'
...
export default global['__wxComponents']['dist/dropdown-menu/index']
</script>
