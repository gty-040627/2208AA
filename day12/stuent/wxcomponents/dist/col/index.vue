<template>
<uni-shadow-root class="dist-col-index"><view :class="'custom-class '+(utils.bem('col', [span]))+' '+(offset ? 'van-col--offset-' + offset : '')" :style="computed.rootStyle({ gutter })">
  <slot></slot>
...
global['__wxRoute'] = 'dist/col/index'
...
export default global['__wxComponents']['dist/col/index']
</script>
