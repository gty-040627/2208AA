<template>
<uni-shadow-root class="dist-switch-index"><view :class="(utils.bem('switch', { on: checked === activeValue, disabled }))+' custom-class'" :style="computed.rootStyle({ size, checked, activeColor, inactiveColor, activeValue })" @click="onClick">
...
global['__wxRoute'] = 'dist/switch/index'
...
export default global['__wxComponents']['dist/switch/index']
</script>
