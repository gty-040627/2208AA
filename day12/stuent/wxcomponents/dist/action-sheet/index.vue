<template>
<uni-shadow-root class="dist-action-sheet-index"><van-popup :show="show" position="bottom" :round="round" :z-index="zIndex" :overlay="overlay" custom-class="van-action-sheet custom-class" :safe-area-inset-bottom="safeAreaInsetBottom" :close-on-click-overlay="closeOnClickOverlay" @close="onClickOverlay">
...
global['__wxRoute'] = 'dist/action-sheet/index'
...
export default global['__wxComponents']['dist/action-sheet/index']
</script>
