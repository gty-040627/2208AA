<template>
<uni-shadow-root class="dist-collapse-item-index"><view :class="'van-collapse-item custom-class '+(index !== 0 ? 'van-hairline--top' : '')">
...
global['__wxRoute'] = 'dist/collapse-item/index'
...
export default global['__wxComponents']['dist/collapse-item/index']
</script>
