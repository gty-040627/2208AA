<template>
<uni-shadow-root class="dist-uploader-index"><view class="van-uploader">
...
global['__wxRoute'] = 'dist/uploader/index'
...
export default global['__wxComponents']['dist/uploader/index']
</script>
