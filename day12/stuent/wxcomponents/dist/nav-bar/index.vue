<template>
<uni-shadow-root class="dist-nav-bar-index"><view v-if="fixed && placeholder" :style="'height: '+(height)+'px;'"></view>
...
global['__wxRoute'] = 'dist/nav-bar/index'
...
export default global['__wxComponents']['dist/nav-bar/index']
</script>
