<template>
<uni-shadow-root class="dist-radio-index"><view :class="(utils.bem('radio', [direction]))+' custom-class'">
...
global['__wxRoute'] = 'dist/radio/index'
...
export default global['__wxComponents']['dist/radio/index']
</script>
