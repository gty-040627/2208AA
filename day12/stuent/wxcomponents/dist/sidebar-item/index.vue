<template>
<uni-shadow-root class="dist-sidebar-item-index"><view :class="(utils.bem('sidebar-item', { selected, disabled }))+' '+(selected ? 'active-class' : '')+' '+(disabled ? 'disabled-class' : '')+' custom-class'" hover-class="van-sidebar-item--hover" hover-stay-time="70" @click="onClick">
...
global['__wxRoute'] = 'dist/sidebar-item/index'
...
export default global['__wxComponents']['dist/sidebar-item/index']
</script>
