<template>
<uni-shadow-root class="dist-count-down-index"><view class="van-count-down">
...
global['__wxRoute'] = 'dist/count-down/index'
...
export default global['__wxComponents']['dist/count-down/index']
</script>
