<template>
<uni-shadow-root class="dist-grid-item-index"><view :class="'custom-class '+(utils.bem('grid-item', { square }))" :style="computed.wrapperStyle({ square, gutter, columnNum, index })" @click="onClick">
...
global['__wxRoute'] = 'dist/grid-item/index'
...
export default global['__wxComponents']['dist/grid-item/index']
</script>
