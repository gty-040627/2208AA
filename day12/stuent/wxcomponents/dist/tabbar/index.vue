<template>
<uni-shadow-root class="dist-tabbar-index"><view :class="(border ? 'van-hairline--top-bottom' : '')+' '+(utils.bem('tabbar', { fixed, safe: safeAreaInsetBottom }))+' custom-class'" :style="zIndex ? 'z-index: ' + zIndex : ''">
  <slot></slot>
</view>
...
global['__wxRoute'] = 'dist/tabbar/index'
...
export default global['__wxComponents']['dist/tabbar/index']
</script>
