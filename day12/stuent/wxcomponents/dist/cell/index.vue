<template>
<uni-shadow-root class="dist-cell-index"><view :class="'custom-class '+(utils.bem('cell', [size, { center, required, borderless: !border, clickable: isLink || clickable }]))" hover-class="van-cell--hover hover-class" hover-stay-time="70" :style="customStyle" @click="onClick">
...
global['__wxRoute'] = 'dist/cell/index'
...
export default global['__wxComponents']['dist/cell/index']
</script>
