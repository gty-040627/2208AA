<template>
<uni-shadow-root class="dist-goods-action-index"><view :class="'custom-class '+(utils.bem('goods-action', { safe: safeAreaInsetBottom }))">
  <slot></slot>
...
global['__wxRoute'] = 'dist/goods-action/index'
...
export default global['__wxComponents']['dist/goods-action/index']
</script>
