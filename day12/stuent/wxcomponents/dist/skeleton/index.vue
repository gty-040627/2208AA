<template>
<uni-shadow-root class="dist-skeleton-index"><view v-if="loading" :class="'custom-class '+(utils.bem('skeleton', [{animate}]))">
...
global['__wxRoute'] = 'dist/skeleton/index'
...
export default global['__wxComponents']['dist/skeleton/index']
</script>
