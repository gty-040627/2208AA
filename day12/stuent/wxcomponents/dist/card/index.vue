<template>
<uni-shadow-root class="dist-card-index"><view class="custom-class van-card">
...
global['__wxRoute'] = 'dist/card/index'
...
export default global['__wxComponents']['dist/card/index']
</script>
