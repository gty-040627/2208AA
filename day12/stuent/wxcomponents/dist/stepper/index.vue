<template>
<uni-shadow-root class="dist-stepper-index"><view :class="(utils.bem('stepper', [theme]))+' custom-class'">
...
global['__wxRoute'] = 'dist/stepper/index'
...
export default global['__wxComponents']['dist/stepper/index']
</script>
