<template>
<uni-shadow-root class="dist-steps-index"><view :class="'custom-class '+(utils.bem('steps', [direction]))">
...
global['__wxRoute'] = 'dist/steps/index'
...
export default global['__wxComponents']['dist/steps/index']
</script>
