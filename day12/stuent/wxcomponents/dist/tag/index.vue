<template>
<uni-shadow-root class="dist-tag-index"><view :class="'custom-class '+(utils.bem('tag', [type, size, { mark, plain, round }]))" :style="computed.rootStyle({ plain, color, textColor })">
  <slot></slot>
...
global['__wxRoute'] = 'dist/tag/index'
...
export default global['__wxComponents']['dist/tag/index']
</script>
