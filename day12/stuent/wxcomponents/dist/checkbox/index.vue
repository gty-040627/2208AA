<template>
<uni-shadow-root class="dist-checkbox-index"><view :class="(utils.bem('checkbox', [{ horizontal: direction === 'horizontal' }]))+' custom-class'">
...
global['__wxRoute'] = 'dist/checkbox/index'
...
export default global['__wxComponents']['dist/checkbox/index']
</script>
