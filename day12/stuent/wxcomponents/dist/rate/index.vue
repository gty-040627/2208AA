<template>
<uni-shadow-root class="dist-rate-index"><view :class="(utils.bem('rate'))+' custom-class'" @touchmove="onTouchMove">
...
global['__wxRoute'] = 'dist/rate/index'
...
export default global['__wxComponents']['dist/rate/index']
</script>
