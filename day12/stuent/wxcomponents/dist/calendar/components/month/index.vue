<template>
<uni-shadow-root class="dist-calendar-components-month-index"><view class="van-calendar__month" :style="computed.getMonthStyle(visible, date, rowHeight)">
...
global['__wxRoute'] = 'dist/calendar/components/month/index'
...
export default global['__wxComponents']['dist/calendar/components/month/index']
</script>
