<template>
<uni-shadow-root class="dist-calendar-components-header-index"><view class="van-calendar__header">
...
global['__wxRoute'] = 'dist/calendar/components/header/index'
...
export default global['__wxComponents']['dist/calendar/components/header/index']
</script>
