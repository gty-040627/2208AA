<template>
<uni-shadow-root class="dist-calendar-calendar"><view class="van-calendar">
...
global['__wxRoute'] = 'dist/calendar/calendar'

Component({})

export default global['__wxComponents']['dist/calendar/calendar']
</script>
