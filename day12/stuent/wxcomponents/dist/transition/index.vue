<template>
<uni-shadow-root class="dist-transition-index"><view v-if="inited" :class="'van-transition custom-class '+(classes)" :style="computed.rootStyle({ currentDuration, display, customStyle })" @transitionend="onTransitionEnd">
  <slot></slot>
...
global['__wxRoute'] = 'dist/transition/index'
...
export default global['__wxComponents']['dist/transition/index']
</script>
