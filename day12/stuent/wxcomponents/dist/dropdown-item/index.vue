<template>
<uni-shadow-root class="dist-dropdown-item-index"><view v-if="showWrapper" :class="(utils.bem('dropdown-item', direction))+' custom-class'" :style="wrapperStyle">
...
global['__wxRoute'] = 'dist/dropdown-item/index'
...
export default global['__wxComponents']['dist/dropdown-item/index']
</script>
