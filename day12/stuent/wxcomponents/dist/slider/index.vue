<template>
<uni-shadow-root class="dist-slider-index"><view :class="'custom-class '+(utils.bem('slider', { disabled, vertical }))" :style="wrapperStyle" @click="onClick">
...
global['__wxRoute'] = 'dist/slider/index'
...
export default global['__wxComponents']['dist/slider/index']
</script>
