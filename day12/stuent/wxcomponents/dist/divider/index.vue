<template>
<uni-shadow-root class="dist-divider-index"><view :class="'custom-class '+(utils.bem('divider', [{ dashed, hairline }, contentPosition]))" :style="computed.rootStyle({ borderColor, textColor, fontSize, customStyle })">
  <slot></slot>
...
global['__wxRoute'] = 'dist/divider/index'
...
export default global['__wxComponents']['dist/divider/index']
</script>
