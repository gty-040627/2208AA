<template>
<uni-shadow-root class="dist-cell-group-index"><view v-if="title" :class="utils.bem('cell-group__title', { inset })">
  {{ title }}
</view>
...
global['__wxRoute'] = 'dist/cell-group/index'
...
export default global['__wxComponents']['dist/cell-group/index']
</script>
