<template>
<uni-shadow-root class="dist-picker-index"><view class="van-picker custom-class">
...
global['__wxRoute'] = 'dist/picker/index'
...
export default global['__wxComponents']['dist/picker/index']
</script>
