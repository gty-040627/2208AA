<template>
<uni-shadow-root class="dist-sticky-index"><view class="custom-class van-sticky" :style="computed.containerStyle({ fixed, height, zIndex })">
...
global['__wxRoute'] = 'dist/sticky/index'
...
export default global['__wxComponents']['dist/sticky/index']
</script>
