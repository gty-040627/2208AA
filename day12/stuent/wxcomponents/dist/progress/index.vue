<template>
<uni-shadow-root class="dist-progress-index"><view class="van-progress custom-class" :style="computed.rootStyle({ strokeWidth, trackColor })">
...
global['__wxRoute'] = 'dist/progress/index'
...
export default global['__wxComponents']['dist/progress/index']
</script>
