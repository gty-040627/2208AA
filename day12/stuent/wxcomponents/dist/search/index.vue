<template>
<uni-shadow-root class="dist-search-index"><view :class="(utils.bem('search', { withaction: showAction || useActionSlot }))+' custom-class'" :style="'background: '+(background)">
...
global['__wxRoute'] = 'dist/search/index'
...
export default global['__wxComponents']['dist/search/index']
</script>
