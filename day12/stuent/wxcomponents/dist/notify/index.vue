<template>
<uni-shadow-root class="dist-notify-index"><van-transition name="slide-down" :show="show" custom-class="van-notify__container" :custom-style="computed.rootStyle({ zIndex, top })" @click.native="onTap">
...
global['__wxRoute'] = 'dist/notify/index'
...
export default global['__wxComponents']['dist/notify/index']
</script>
