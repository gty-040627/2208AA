<template>
<uni-shadow-root class="dist-panel-index"><view class="van-panel van-hairline--top-bottom custom-class">
...
global['__wxRoute'] = 'dist/panel/index'
...
export default global['__wxComponents']['dist/panel/index']
</script>
