<template>
<uni-shadow-root class="dist-submit-bar-index"><view class="van-submit-bar custom-class">
  <slot name="top"></slot>
...
global['__wxRoute'] = 'dist/submit-bar/index'
...
export default global['__wxComponents']['dist/submit-bar/index']
</script>
