<template>
<uni-shadow-root class="dist-cascader-index"><view v-if="showHeader" class="van-cascader__header">
...
global['__wxRoute'] = 'dist/cascader/index'
...
export default global['__wxComponents']['dist/cascader/index']
</script>
