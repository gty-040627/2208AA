<template>
<uni-shadow-root class="dist-loading-index"><view :class="'custom-class '+(utils.bem('loading', { vertical }))">
...
global['__wxRoute'] = 'dist/loading/index'
