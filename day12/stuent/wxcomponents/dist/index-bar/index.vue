<template>
<uni-shadow-root class="dist-index-bar-index"><view class="van-index-bar">
  <slot></slot>
...
global['__wxRoute'] = 'dist/index-bar/index'
...
export default global['__wxComponents']['dist/index-bar/index']
</script>
