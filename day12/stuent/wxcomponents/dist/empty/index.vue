<template>
<uni-shadow-root class="dist-empty-index"><view class="custom-class van-empty">
...
global['__wxRoute'] = 'dist/empty/index'
...
export default global['__wxComponents']['dist/empty/index']
</script>
