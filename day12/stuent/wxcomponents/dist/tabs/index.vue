<template>
<uni-shadow-root class="dist-tabs-index"><view :class="'custom-class '+(utils.bem('tabs', [type]))">
...
global['__wxRoute'] = 'dist/tabs/index'
...
export default global['__wxComponents']['dist/tabs/index']
</script>
