<template>
<uni-shadow-root class="dist-share-sheet-options"><view :class="utils.bem('share-sheet__options', { border: showBorder })">
...
global['__wxRoute'] = 'dist/share-sheet/options'
...
export default global['__wxComponents']['dist/share-sheet/options']
</script>
